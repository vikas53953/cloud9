...
const CSS = path.join(process.env.LOCALAPPDATA ?? path.join(os.homedir(), "AppData", "Local"),
  "Programs", "Cloud9", "resources", "app", "dist-web", "assets", "index-C4OA17Nr.css");
...
fs.writeFileSync(path.join(OUT, "contrast-data.json"), JSON.stringify(rows, null, 1));
