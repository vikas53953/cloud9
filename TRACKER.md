...
`9429c48`. PR #27 is OPEN and pending independent review; owner-only CRUD,
...
`4a22f36`. Evidence: shared, engine, and relay builds pass; engine host 18/18
