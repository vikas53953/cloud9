...
function WorkflowDetail({ workflow, runs, onEdit, onRun, onArchive, onStop, onRetry, agents }: {
  ...
  return <div className="workflow-detail-inner"><header className="workflow-detail-head"><div>
    ...
    <div className="workflow-meta"><span>Channel {workflow.channelId}</span><span>{workflow.steps.length} {workflow.steps.length === 1 ? "step" : "steps"}</span><span>Manual only · no schedules</span><span>Separate from the agent Workflow tool</span><span>Archive keeps history</span></div>
